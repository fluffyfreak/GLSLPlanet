...
float GetHeight(in vec3 p)
{
	...
	if (n < 0.01) n += megavolcano_function(octaves[7], amplitude[7], frequency[7], lacunarity[7], p) * n * 800.0;
	...
	if ((m_seed>>2) %3 > 2) {
		...
		if (n < 0.2) n += canyon2_ridged_function(octaves[8], amplitude[8], frequency[8], lacunarity[8], p) * n * 2;
		...
		if (n < 0.2) n += canyon_ridged_function(octaves[8], amplitude[8], frequency[8], lacunarity[8], p) * n * 2;
		...
		if (n < 0.2) n += canyon3_ridged_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon2_ridged_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon_ridged_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon2_billow_function(octaves[8], amplitude[8], frequency[8], lacunarity[8], p) * n * 2;
		...
		if (n < 0.2) n += canyon_billow_function(octaves[8], amplitude[8], frequency[8], lacunarity[8], p) * n * 2;
		...
		if (n < 0.2) n += canyon3_billow_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon2_billow_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon_billow_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon2_voronoi_function(octaves[8], amplitude[8], frequency[8], lacunarity[8], p) * n * 2;
		...
		if (n < 0.2) n += canyon_voronoi_function(octaves[8], amplitude[8], frequency[8], lacunarity[8], p) * n * 2;
		...
		if (n < 0.2) n += canyon3_voronoi_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon2_voronoi_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
		...
		if (n < 0.2) n += canyon_voronoi_function(octaves[9], amplitude[9], frequency[9], lacunarity[9], p) * n * 2;
