...
float GetHeight(in vec3 p)
{
	...
	float n = continents * amplitude[0] * 2.0 ;//+ (cliff_function(octaves[6], amplitude[6], frequency[6], lacunarity[6], p)*0.5);
	...
	//m = (n<1.0 ? n : 1.0/n ); //sometimes creates some interesting features
